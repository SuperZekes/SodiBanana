...
5. <a href="https://modrinth.com/mod/resourcify">Resourcify</a> Last but not least is Resourcify the mod adds a little plus button to the resource pack menu so you can add resource packs from in game same thing for shaderpacks and datapacks. (only in versions 3.4.3 or newer)
